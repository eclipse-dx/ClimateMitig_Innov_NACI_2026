...
* - Build the finale databases for invention (number of technology invented per year per country per technology field)
...
* All innovation using docdb (all technologies: BENCHMARK)
